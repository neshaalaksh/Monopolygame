...
square[15] = new Square("Pennsylvania RR", "$200", "#FFFFFF", 200, 1);
square[16] = new Square("St. James Place", "$180", "#FFA500", 180, 6, 14, 70, 200, 550, 750, 950);
square[17] = new Square("Chest", "", "#FFFFFF");
...
square[25] = new Square("B & O RR", "$200", "#FFFFFF", 200, 1);
...
square[30] = new Square("Go to Jail", "", "#FFFFFF");
...
square[33] = new Square("Chest", "", "#FFFFFF");
square[34] = new Square("Pennsylvania Avenue", "$320", "#008000", 320, 9, 28, 150, 450, 1000, 1200, 1400);
square[35] = new Square("Short Line RR", "$200", "#FFFFFF", 200, 1);
square[36] = new Square("Chance", "", "#FFFFFF");
square[37] = new Square("Park Place", "$350", "#0000FF", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("Lux TAX", "Pay $100", "#FFFFFF");
