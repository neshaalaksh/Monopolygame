...
function useJailCard() {
	...
	if (p.communityChestJailCard) {
		...
		communityChestCards.deck.splice(communityChestCards.index, 1, 0);
		...
		chanceCards.deck.splice(chanceCards.index, 1, 0);
...
window.onload = function() {
	...
	//Go
	document.getElementById("enlarge0name").innerHTML = 'GO';
	document.getElementById("enlarge0price").innerHTML = 'COLLECT $200 SALARY AS YOU PASS';	
	//Community Chest and Chance
	document.getElementById("enlarge2name").innerHTML = 'Community Chest';
	document.getElementById("enlarge2price").innerHTML = 'FOLLOW INSTRUCTIONS ON TOP CARD';
	document.getElementById("enlarge7name").innerHTML = 'Chance';
	document.getElementById("enlarge7price").innerHTML = 'FOLLOW INSTRUCTIONS ON TOP CARD';
	document.getElementById("enlarge17name").innerHTML = 'Community Chest';
	document.getElementById("enlarge17price").innerHTML = 'FOLLOW INSTRUCTIONS ON TOP CARD';
	document.getElementById("enlarge22name").innerHTML = 'Chance';
	document.getElementById("enlarge22price").innerHTML = 'FOLLOW INSTRUCTIONS ON TOP CARD';
	document.getElementById("enlarge33name").innerHTML = 'Community Chest';
	document.getElementById("enlarge33price").innerHTML = 'FOLLOW INSTRUCTIONS ON TOP CARD';
	document.getElementById("enlarge36name").innerHTML = 'Chance';
	document.getElementById("enlarge36price").innerHTML = 'FOLLOW INSTRUCTIONS ON TOP CARD';
	//free parking
	document.getElementById("enlarge20name").innerHTML = 'Free Parking';
	//jail
	document.getElementById("enlarge30name").innerHTML = 'Go to Jail';
	document.getElementById("enlarge30price").innerHTML = 'Go directly to Jail. Do not pass GO. Do not collect $200.';
	document.getElementById("enlarge10name").innerHTML += ' Jail';
	//railroad
	document.getElementById("enlarge5name").innerHTML = 'Reading Railroad';
	document.getElementById("enlarge5price").innerHTML = '$200';
	document.getElementById("enlarge15name").innerHTML = 'Pennsylvania Railroad';
	document.getElementById("enlarge15price").innerHTML = '$200';
	document.getElementById("enlarge25name").innerHTML = 'B & O Railroad';
	document.getElementById("enlarge25price").innerHTML = '$200';
	document.getElementById("enlarge35name").innerHTML = 'Short Line Railroad';
	document.getElementById("enlarge35price").innerHTML = '$200';

	document.getElementById("enlarge38name").innerHTML = 'Luxury Tax';
	// Jail corrections
